...
import com.google.cloud.bigquery.TableResult;
  ...
  * 
  * 
  * Class which defines methods that set and run queries, using Google BigQuery service.
  * Is also defined the method able to fill a list with query results.
  * 
  * Classe che definisce i metodi in grado di impostare le query, interfacciandosi con il servizio BigQuery di Google.
  * Inoltre è definita il metodo in grado di riempire la lista coi risultati delle query.
  * 
  */
