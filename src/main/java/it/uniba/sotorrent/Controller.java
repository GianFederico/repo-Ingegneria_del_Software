 ...
 */
   ...
   */
    ...
    switch (u.getQuery()) {
      case "1":
        job = soq.runQuerySprint1(u.getYyyy(), u.getMm(), u.getDd(), u.getType(), u.getLimit());
        break;
      case "2":
        job = soq.runQuerySprint1(u.getYyyy(), u.getMm(), u.getType(), u.getTaglike(), u.getLimit());
        break;
      case "3": case "6":
        job = soq.runQuerySprint2(u.getYyyy(), u.getMm(), u.getDd(), u.getLimit(), u.getGroupby(), u.getColumn3());
        break;
      case "4": case "7":
        job = soq.runQuerySprint2(u.getUser(), u.getLimit(), "Ris", "Domande", "Risposte",
            u.getGroupby(), u.getColumn3());
        break;
      case "5": case "8":
        job = soq.runQuerySprint2(u.getUser(), u.getLimit(), "Dom", "Risposte", "Domande",
            u.getGroupby(), u.getColumn3());
        break;
      default:
        break;
